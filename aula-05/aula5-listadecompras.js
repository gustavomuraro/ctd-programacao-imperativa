let listaCompras=['banana',' maçã',' água com gás'];

console.log("O método join() junta todos os elementos de um array em uma string e retorna esta string.")
...
console.log(listaCompras.push("goiaba"));
...
console.log(listaCompras.unshift("melão"));